<template>
<v-card
  class="bubble bubble bubble_right" 
  color="#1982FC"
...
>>>>>>> 72ef8e665b8870d59f361ceb34b514e39a1ec06d
    class="text-left"
  >
  </v-card-subtitle>
  <v-card-text
...
@Component
export default class MyBubbleMsg extends Vue {
  
  @Prop({ type: Object, default: new Messages() })
  msg!: Messages
